...
file_name_save = 'cross_validation_results/1pp/train_data_distances_1pp_facenet_no_mining_cv_'+str(num)+'.csv'
...
file_name_save = 'cross_validation_results/1pp/test_data_distances_1pp_facenet_no_mining_cv_'+str(num)+'.csv'
with open(file_name_save, 'w', encoding="ISO-8859-1", newline='') as myfile:
    wr = csv.writer(myfile)
    wr.writerow(('positive_distances','negative_distances'))
    wr.writerows(export_data)
...
file_name_save = 'cross_validation_results/5pp/train_data_distances_5pp_facenet_no_mining_cv_'+str(num)+'.csv'
with open(file_name_save, 'w', encoding="ISO-8859-1", newline='') as myfile:
    wr = csv.writer(myfile)
    wr.writerow(('positive_distances','negative_distances'))
    wr.writerows(export_data)
...
file_name_save = 'cross_validation_results/5pp/test_data_distances_5pp_facenet_no_mining_cv_'+str(num)+'.csv'
with open(file_name_save, 'w', encoding="ISO-8859-1", newline='') as myfile:
    wr = csv.writer(myfile)
    wr.writerow(('positive_distances','negative_distances'))
    wr.writerows(export_data)
