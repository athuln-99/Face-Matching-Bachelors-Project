...
siamese_file_name = 'cross_validation_trained_models/siamesemodel_l1Dist_facenet_with_hard_mining_cv_'+str(num)+'.h5'
...
file_name = 'cross_validation_data/siamese_training_1pp_data_cv_'+str(num)+'.csv'
...
file_name = 'cross_validation_data/siamese_testing_1pp_data_cv_'+str(num)+'.csv'
...
for idx, batch in enumerate(train_data):
    ...
    for idx in range(0, len(batch[0])):
        if(batch[2][idx] == 1):
            positive_distances.append(test[idx][0])
        else:
            negative_distances.append(test[idx][0])

d = [positive_distances, negative_distances]
export_data = zip_longest(*d, fillvalue = '')


file_name_save = 'cross_validation_results/1pp/train_data_distances_1pp_facenet_with_mining_cv_'+str(num)+'.csv'
...
file_name_save = 'cross_validation_results/1pp/test_data_distances_1pp_facenet_with_mining_cv_'+str(num)+'.csv'
with open(file_name_save, 'w', encoding="ISO-8859-1", newline='') as myfile:
    wr = csv.writer(myfile)
    wr.writerow(('positive_distances','negative_distances'))
    wr.writerows(export_data)
...
file_name = 'cross_validation_data/siamese_training_5pp_data_cv_'+str(num)+'.csv'
df = pd.read_csv(file_name)
...
file_name = 'cross_validation_data/siamese_testing_5pp_data_cv_'+str(num)+'.csv'
dfa = pd.read_csv(file_name)
...
file_name_save = 'cross_validation_results/5pp/train_data_distances_5pp_facenet_with_mining_cv_'+str(num)+'.csv'
with open(file_name_save, 'w', encoding="ISO-8859-1", newline='') as myfile:
    wr = csv.writer(myfile)
    wr.writerow(('positive_distances','negative_distances'))
    wr.writerows(export_data)
...
file_name_save = 'cross_validation_results/5pp/test_data_distances_5pp_facenet_with_mining_cv_'+str(num)+'.csv'
with open(file_name_save, 'w', encoding="ISO-8859-1", newline='') as myfile:
    wr = csv.writer(myfile)
    wr.writerow(('positive_distances','negative_distances'))
    wr.writerows(export_data)
